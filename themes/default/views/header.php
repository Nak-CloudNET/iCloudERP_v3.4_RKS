                            ...
                            ?>
                                ...
                                <li class="mm_sales mm_sale_order <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
										...
										<li id="list_sale_assign">
                                            <a class="submenu" href="<?= site_url('sales/list_sale_assign'); ?>">
                                                <i class="fa fa-credit-card"></i>
                                                <span class="text"> <?= lang('list_sale_assign'); ?></span>
                                            </a>
                                        </li>
                                        ...
                                        <ul>
                                            ...
                                            <?php if (POS) { ?>
                                                ...
                                                <?php } ?>
													...
													<li id="system_settings_categories_note">
                                                        <a href="<?= site_url('system_settings/categories_note') ?>">
                                                            <i class="fa fa-sitemap"></i><span class="text"> <?= lang('categories_note'); ?></span>
                                                        </a>
                                                    </li>
                                            ...
                                            <ul>
														...
														<?php } ?>
															...
															<?php } ?>
																	...
																	<li id="reports_inventory_inout">
																		<a href="<?= site_url('reports/product_grossmargin') ?>">
																			<i class="fa fa-barcode"></i><span class="text"> <?= lang('products_grossmargin'); ?></span>
																		</a>
																	</li>
																	-->
																	<li id="reports_inventory_inout">
												...
												<li class="mm_purchase_report">
													...
													<ul>
														...
														<li id="reports_purchases">
															<a href="<?= site_url('reports/purchase_details') ?>">
																<i class="fa fa-star"></i><span class="text"> <?= lang('purchase_details'); ?></span>
															</a>
														</li>
														
														<li id="reports_purchases">
															<a href="<?= site_url('reports/purchase_order_details') ?>">
																<i class="fa fa-star"></i><span class="text"> <?= lang('purchase_order_details'); ?></span>
															</a>
														</li>
									...
									<ul>
										...
										<li class="mm_product_report">
											...
											<ul>  
												...
												<li id="reports_inventory_inout">
													<a href="<?= site_url('reports/product_grossmargin') ?>">
														<i class="fa fa-money"></i><span class="text"> <?= lang('products_grossmargin'); ?></span>
													</a>
												</li>
												-->
