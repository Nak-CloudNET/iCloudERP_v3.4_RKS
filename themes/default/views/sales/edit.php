...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($inv) { ?>
        localStorage.setItem('edit_sale', '<?= $edit_sale; ?>');
        ...
        localStorage.setItem('slrefh', '<?= $inv->reference_no ?>');
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_hidden('reference_no_h', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $inv->reference_no), 'class="form-control input-tip" id="slrefh" required="required"'); ?>
