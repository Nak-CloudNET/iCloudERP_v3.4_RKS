        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('I1', lang('group_area'));
                    $this->excel->getActiveSheet()->SetCellValue('J1', lang('note'));
                    $this->excel->getActiveSheet()->SetCellValue('K1', lang('deposit'));
                    $this->excel->getActiveSheet()->SetCellValue('L1', lang('award_points'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('I' . $row, $customer->areas_group);
                        $this->excel->getActiveSheet()->SetCellValue('J' . $row, $customer->invoice_footer);
                        $this->excel->getActiveSheet()->SetCellValue('K' . $row, $customer->deposit_amount);
                        $this->excel->getActiveSheet()->SetCellValue('L' . $row, $customer->award_points);

                        $row++;

                        $this->excel->getActiveSheet()->getStyle('A' . $row . ':L' . $row)->getFont()
                                ->setName('Times New Roman')
                                ->setSize(12);
